...
def extract_cricket_data(url,Match_Details):
    ...
    if response.status_code == 200:
        ...
        os.makedirs('/home/umukesh/Desktop/algorithmic_trading/data/raw/2023/innings1', exist_ok=True)
        os.makedirs('/home/umukesh/Desktop/algorithmic_trading/data/raw/2023/innings2', exist_ok=True)
        os.makedirs('/home/umukesh/Desktop/algorithmic_trading/data/processed/2023', exist_ok=True)

        # Construct full file paths for the directories
        innings1_filename = f'innings1_{name}_2023.csv'
        innings2_filename = f'innings2_{name}_2023.csv'
        result_filename = f'data_{name}_2023.csv'

        innings1_filepath = f'/home/umukesh/Desktop/algorithmic_trading/data/raw/2023/innings1/{innings1_filename}'
        innings2_filepath = f'/home/umukesh/Desktop/algorithmic_trading/data/raw/2023/innings2/{innings2_filename}'
        result_filepath = f'/home/umukesh/Desktop/algorithmic_trading/data/raw/2023/match/{result_filename}'
    ...
    # Check if the missing_data.json file exists
        ...
        if name not in missing_data['2023']:
            missing_data['2023'].append(name)
...
# Example usage:
# url = "https://www.cricketmazza.com/gameinfo/indian-premier-league-2023-kolkata-knight-riders-royal-challengers-bengaluru-ipl--36th"
# innings1, innings2, result = extract_cricket_data(url)


df = pd.read_csv('/home/umukesh/Desktop/algorithmic_trading/data/raw/URL/ipl2023.csv')
